...
export default function ContactSection({ alamat, telepon, email }: Props) {
    ...
    return (
        <section id="kontak" ref={sectionRef} className="relative overflow-hidden bg-[#111111] py-28 lg:py-36">
            ...
            <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className={`mb-16 transition-all duration-700 ${visible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-xs font-bold tracking-[0.3em] text-[#F5B800] uppercase">Kontak</span>
                    </div>
                    <h2 className="text-4xl font-black leading-tight tracking-tight text-white lg:text-6xl uppercase">
                        Hubungi
                        <br />
                        <span className="text-[#F5B800]">Tim Kami</span>
                    </h2>
                ...
                <div className="grid gap-10 lg:grid-cols-5">
                    ...
                    <div className={`lg:col-span-3 transition-all duration-700 delay-200 ${visible ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'}`}>
                        <div className="rounded-2xl border border-white/5 bg-white/[0.03] p-6 sm:p-8 lg:p-10">
                            ...
                            <button className="group mt-6 flex items-center gap-2 rounded-lg bg-linear-to-r from-[#F5B800] to-[#E0A800] px-8 py-4 text-sm font-bold tracking-widest text-[#181819] uppercase shadow-lg shadow-[#F5B800]/20 transition-all hover:shadow-xl hover:shadow-[#F5B800]/30 active:scale-95">
                    ...
                    <div className={`flex flex-col gap-5 lg:col-span-2 transition-all duration-700 delay-300 ${visible ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'}`}>
                        {[
                            ...
                            return (
                                <div key={info.label} className="group flex gap-5 rounded-2xl border border-white/5 bg-white/[0.03] p-7 transition-all hover:border-[#F5B800]/15 hover:bg-[#F5B800]/5">
